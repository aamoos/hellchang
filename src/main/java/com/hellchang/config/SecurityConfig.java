package com.hellchang.config;

import com.hellchang.jwt.JwtAccessDeniedHandler;
import com.hellchang.jwt.JwtAuthenticationEntryPoint;
import com.hellchang.jwt.JwtSecurityConfig;
...
//                    .antMatchers("/auth/authenticate").permitAll() //해당 Path 요청들은 인증없이 접근 설정
//                    .antMatchers("/auth/signup").permitAll()
//                    .antMatchers("/auth/idCkeck").permitAll()
